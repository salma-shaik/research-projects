...
"""
nat_cen_constant_vars = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Agency_Replicated.csv')
...
nat_cen_fixed_rows_yr.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Agency_Years_Replicated.csv', index=False)
