...
cen_90_00_10 = pd.read_csv(
    '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/merge_files/census_crime/Census_Updated_Glevels_From_Crime_Missing_Census_Filled.csv')
...
"""
All the 2015 are rows are added at the bottom so need to sort again by ORI and YEAR to get the 4 occurrences of each ORI together 
...
# Write this to a csv
cen_90_00_10_sorted.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/merge_files/census_crime/Census_90-15_Final_Sorted.csv', index=False)
