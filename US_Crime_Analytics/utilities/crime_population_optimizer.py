...
def get_crime_dec():
  ...
  #  crime_df_msng_cen_entry = get_incomplete_county_crime_years_ori(crime_df)
    ...
    ori_list_df = pd.DataFrame(ori_list, columns=['ORI'])

    all_msng_cen_cr = crime_df_zero_dec_pop_ORIs.append([ori_list_df], sort=False)

    print(all_msng_cen_cr)

    all_msng_cen_cr['ORI'].to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_missing_decennial_pop_oris.csv', index=False)
    ...
    crime_df_zero_dec_pop.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_missing_decennial_pop.csv', index=False)

    crime_df_non_zero_dec_pop.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_without_missing_dec_pop_oris.csv', index=False)
    ...
    crime_counties.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties.csv', index=False)

    crime_cities = crime_df_non_zero_dec_pop[(crime_df_non_zero_dec_pop.Govt_level == 2) | (crime_df_non_zero_dec_pop.Govt_level == 3)]
    crime_cities.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities.csv', index=False)

    # Get the decennial crime data for counties.
    crime_counties_dec = crime_counties[(crime_counties.crime_year == 1990) | (crime_counties.crime_year == 2000) | (crime_counties.crime_year == 2010) | (crime_counties.crime_year == 2015)]
    ...
    crime_counties_dec.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties_dec.csv', index=False)
    ...
    crime_cities_dec.to_csv(
        '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities_dec.csv',
        index=False)
...
def interpolate_population(crime_df, fl_name):
    ...
    crime_pop_int_geo_final.to_csv(f'/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/{fl_name}.csv',index=False)
...
def get_final_geo_crime_file(ini_fl, int_fl, op_file):
    ...
    crime_geo_final_df.to_csv(
        f'/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/{op_file}.csv',
        index=False)


def append_crime_int_data():
    crime_counties_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties_pop_int_merged.csv')
    crime_cities_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities_pop_int_merged.csv')

    final_crime = crime_counties_df.append([crime_cities_df], sort=False)

    final_crime.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_population_fixed.csv', index=False)
    ...
    final_crime_sorted.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/final_crime_for_merge.csv', index=False)
...
#interpolate_population('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties_dec.csv', 'crime_counties_pop_int')

# 3. Interpolate city population between census years
#interpolate_population('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities_dec.csv', 'crime_cities_pop_int')

# 4. merge int pop county with ini cnty
#get_final_geo_crime_file('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties.csv',
 #                     '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_counties_pop_int.csv', 'crime_counties_pop_int_merged')

# 4. merge int pop city with ini city
#get_final_geo_crime_file('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities.csv',
 #                       '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/crime_data/crime_cities_pop_int.csv','crime_cities_pop_int_merged')
