...
def get_census_data_from_api(base_url, fips_df, op_file, census_year=None):
    ...
    with open(f'/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/census_cities_1990/twnshps_api/{op_file}.csv', 'w') as file_wrtr:
...
# Get 2010 township census data
fips_90 = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/wip_merge_files/st_cnty_fips_1990.csv')
...
final_df = create_final_twnshp_file('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/census_cities_1990/twnshps_api',
                                    '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/census_cities_1990/new_census_townships_90_initial.csv')
...
final_df_sorted.to_csv(
    '/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/census_cities_1990/new_census_townships_90.csv',
    index=False)