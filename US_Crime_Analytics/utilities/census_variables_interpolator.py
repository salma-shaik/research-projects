...
interpolated_df = interpolate_census_vars('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/merge_files/census_crime/Census_90-15_Final_Sorted.csv')
# Write the df with interpolated values for all population variables to a csv
interpolated_df.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Pop_Vars_Interpolated.csv', index=False)
...
def replace_negative_values():
    ...
    int_df.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Pop_Vars_Interpolated_Negative_Extrapolated_Pop_Zeroed.csv', index=False)
...
def write_final_intpltd_file():
    ...
    fixed_rows_yr = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Agency_Years_Replicated.csv')
    interpolated_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Pop_Vars_Interpolated_Negative_Extrapolated_Pop_Zeroed.csv')
    ...
    final_int_df.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/interpolated_files/Census_Interpolated.csv', index=False)
