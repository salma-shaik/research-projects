...
def update_90_census_with_new_twnshps():
    ...
    townships_new_census_vars_90_glevel = townships_new_census_vars_90.merge(crime_major_gov_fips,
                                                                             on=['STATEFP', 'place_fips'], how='right')
   ...
   # cities_new_cen_vars_90 = townships_new_census_vars_90_glevel[(townships_new_census_vars_90_glevel.Govt_level == 2)]
    ...
    cen_90_new_twnshps.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/census_cities_1990/new_census_variables/cen_90_ini_cnty_city_new_twnshp_glevels.csv', index=False)
