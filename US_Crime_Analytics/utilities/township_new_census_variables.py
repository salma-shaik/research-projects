...
def append_city_twnshp(city_df, twnshp_df, op_file):
    ...
    city_df.to_csv(f'/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/census_cities_2000/new_census_variables/{op_file}.csv',index=False)
...
"""
ini_twnshp_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/wip_merge_files/new_census_townships_00_initial.csv')
...
write_final_df_csv(new_twnshp_race_pct_df, 'townships_new_census_vars_00')

city_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/census_cities_2000/new_census_variables/new_vars_census_cities_2000.csv')
append_city_twnshp(city_df, new_twnshp_race_pct_df, 'new_vars_census_cities_townships_00')
...
# new_twnshp_race_df = create_race_cols(ini_twnshp_df, new_twnshp_df)
# new_twnshp_race_pct_df = create_white_perc_cols(new_twnshp_race_df)
# write_final_df_csv(new_twnshp_race_pct_df, 'townships_new_census_vars_10')
#
