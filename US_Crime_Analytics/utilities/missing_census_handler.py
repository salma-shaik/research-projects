...
def common_missing_crime_cen():
    cen_90 = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/merge_files/census_crime/Crime_Unmatched_With_Census_1990.csv')
    cen_00 = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/merge_files/census_crime/Crime_Unmatched_With_Census_2000.csv')
    cen_10 = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/merge_files/census_crime/Crime_Unmatched_With_Census_2010.csv')
    ...
    missing_common_ori.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/main_census_merge/data/merge_files/census_crime/Crime_Unmatched_With_Census_Common_ORI.csv', index=False)
...
ini_cens_df = pd.read_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/merge_files/census_crime/Census_Crime_All_Right_Sorted.csv')
#
census_df = fill_empty_census(ini_cens_df)
census_df.to_csv('/Users/salma/Studies/Research/Criminal_Justice/research_projects/US_Crime_Analytics/data/merge_files/census_crime/Census_Updated_Glevels_From_Crime_Missing_Census_Filled.csv', index=False)
