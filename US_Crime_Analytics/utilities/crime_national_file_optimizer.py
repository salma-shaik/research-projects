...
def get_req_crime_data_from1990(file_path):
    ...
    print('ini_crime_df ', ini_crime_df.shape[0])

    ini_crime_df_from1990 = ini_crime_df[ini_crime_df.year >= 1990]
    print('ini_crime_df from 1990', ini_crime_df_from1990.shape[0])

    # Write the crime data from 1990 to a csv.
    ini_crime_df_from1990.to_csv('C:/Users/arvind1613/OneDrive/Desktop/General/Projects/main_census_merge/data/cleaned_files/crime/Crime_1990_2015.csv', index=False)
    ...
    print('crime_req_vars from 1990', crime_req_vars_df.shape[0])

    #  Write this df with required variables to a csv.
    crime_df.to_csv('C:/Users/arvind1613/OneDrive/Desktop/General/Projects/main_census_merge/data/cleaned_files/crime/Crime_1990_2015_Req_Vars.csv', index=False)

    # Drop the duplicate ORIs
    crime_df_uniq_ori = crime_df.drop_duplicates(subset=['ori_code'])
    print('crime_req_vars from 1990 unique', crime_df_uniq_ori.shape[0])

    crime_df_uniq_ori.to_csv('C:/Users/arvind1613/OneDrive/Desktop/General/Projects/main_census_merge/data/cleaned_files/crime/Crime_1990_2015_Req_Vars_Unique.csv', index=False)
